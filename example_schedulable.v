...
Definition job_ex1 : Job := mkJob 0 2 3.
...
(** 補助補題: service の上界（cpu_count ≤ m を使う） *)
...
Definition job_ex2 : Job := mkJob 0 3 2.
...
(** したがって、どんなスケジュールも schedulable にはなれない *)
Lemma ex2_not_schedulable : forall sched, ~schedulable jobs_ex2 1 sched.
Proof.
  intros sched Hsched.
  unfold schedulable in Hsched.
  exact (Hsched 0 (ex2_any_sched_misses sched)).
Qed.
