...
Lemma global_edf_semantic_validity :
  forall candidates_of jobs m sched,
    scheduler_rel (global_edf_scheduler candidates_of) jobs m sched ->
...
Proof.
  ...
  exact (top_m_algorithm_semantic_validity
           global_edf_top_m_spec candidates_of jobs m sched Hrel).
Qed.
...
Lemma global_edf_selected_from_subset_eligible :
  forall J candidates_of jobs m sched t,
    CandidateSourceSpec J candidates_of ->
    scheduler_rel (global_edf_scheduler candidates_of) jobs m sched ->
    top_m_selected_from
...
Lemma global_edf_selected_from_subset_admissible_somewhere_strong_gen :
...
Proof.
  ...
  exact
    (top_m_algorithm_not_running_subset_admissible_somewhere_interval_implies_full_supply_gen
       adm J global_edf_top_m_spec candidates_of jobs m sched t1 t2 j
...
Proof.
  ...
  exact
    (top_m_algorithm_not_running_subset_eligible_interval_implies_full_supply
       J global_edf_top_m_spec candidates_of jobs m sched t1 t2 j
       Hcand Hrel HJ Hinterval).
Qed.
