...
(* Compatibility wrappers for older APIs that exposed the busy-prefix
   start/carry obligations separately instead of using
...
Proof.
  ...
  intros j Hj.
  destruct (Hjob_bridge j Hj) as [Hj_H [t1 [t2 [Hwit [Ht1rel Hcarry_free]]]]].
...
Proof.
  ...
  eapply periodic_edf_schedulable_by_window_dbf_on_finite_horizon_generated_with_busy_prefix_bridge;
    eauto.
  intros j Hj.
  destruct (Hjob_bridge j Hj) as [Hj_H [Hstart Hcarry]].
  split; [exact Hj_H |].
